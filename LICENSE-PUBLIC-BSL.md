...
## Licensed Work (composants réseau public)

S'applique aux fonctionnalités et au code explicitement marqués « PUBLIC » dans `LICENCE_ARTCB.md` annexe A, notamment :

- filtrage et lecture `visibility=public` sur la chaîne ;
- publication opt-in de blocs publics ;
- explorer / API lecture seule du réseau public ;
- documentation du protocole public.

**N'inclut pas** les modules groupe ou privé (voir LICENSE-PROPRIETAIRE.md).
...
As of the Change Date, or the fourth anniversary of the first publicly
...
of the Licensed Work, are subject to this License. This License is
explicitly not intended to limit any rights you have under applicable fair
use, fair dealing, or other exceptions.

No trademark license is granted in this License, neither for names, logos,
nor products. The Licensed Work is provided "AS IS", without warranty.
